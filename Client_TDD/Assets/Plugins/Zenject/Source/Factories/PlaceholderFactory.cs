...
namespace Zenject
{
        ...
        : PlaceholderFactoryBase<TValue>, IFactory<TParam1, TValue>
    {
        ...
        [NotNull]
#endif
        public virtual TValue Create(TParam1 index)
        {
            return CreateInternal(
                new List<TypeValuePair>
                {
                    InjectUtil.CreateTypePair(index)
                });
        }
        ...
        : PlaceholderFactoryBase<TValue>, IFactory<TParam1, TParam2, TValue>
    {
        ...
        [NotNull]
#endif
        public virtual TValue Create(TParam1 parent, TParam2 info)
        {
            return CreateInternal(
                new List<TypeValuePair>
                {
                    InjectUtil.CreateTypePair(parent),
                    InjectUtil.CreateTypePair(info)
                });
        }
