...
namespace Basra.Server.Services
{
    ...
    public class ServerLoop : IServerLoop
    {
        ...
        private const int PendingRoomTimeout = 2 * 1000; //todo change
        ...
        private const int ReadyTimeout = 100 * 1000; //todo change
        ...
        private const int BotPlayMin = 200, BotPlayMax = 250; //todo change
