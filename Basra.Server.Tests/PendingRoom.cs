...
//            var hub = new MasterHub(masterRepo.Object)
//            {
//                Context = context.Object,
//                Clients = clients.Object,
//            };

//            await Server.PendingRoom.AskForRoom(hub, targetRoomGenre, targetRoomUCount, masterRepo.Object);

//#pragma warning disable xUnit2000 
//            // Constants and literals should be the expected argument
//            Assert.Equal(Server.PendingRoom.All.Count, 1);
