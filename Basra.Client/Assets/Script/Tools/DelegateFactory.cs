...
//             var paramExpressions = CreateParameterExpressions(method, argumentsParameter);

//             MethodCallExpression call = Expression.Call(instance, method, paramExpressions);

//             var callAsObject = Expression.Convert(call, typeof(object));

//             Expression<LateBoundMethod> lambda = Expression.Lambda<LateBoundMethod>(callAsObject, instanceParameter, argumentsParameter);
